...
const showDanielaBio = document.getElementById("Staff6")
showDanielaBio.addEventListener('click', ShowBio("#Staff6Button", "#Staff6Bio"))

const hideDanielaBio = document.getElementById("Staff6Bio")
hideDanielaBio.addEventListener('click', hideBio('.closeButton', '#Staff6Bio'))
